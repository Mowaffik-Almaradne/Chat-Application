...
class ApiUrl {
  late String _link;
  final String baseUrl = "https://mobiletest.tuqaatech.com/api/";
    ...
    for (int i = 0; i < query.length; i++) {
      ...
      if (value is List) {
        for (int i = 0; i < value.length; i++) {
          var it = value.elementAt(i); // if thw values of map is a list

          _link += '$key=$it';
          //hobbies=reading & hobbies=swimming & hobbies=travelling
          if (i < value.length - 1) {
            _link += '&';
          }
        }
